...
namespace YourNamespace.Models
{
    ...
    public class EmailButtonModel
    {
        ...
        /// <summary>
        /// Creates a default success button
        /// </summary>
        public static EmailButtonModel CreateSuccess(string url, string text)
        {
            return new EmailButtonModel
            {
                Url = url,
        ...
        /// <summary>
        /// Creates a default danger button
        /// </summary>
        public static EmailButtonModel CreateDanger(string url, string text)
        {
            return new EmailButtonModel
            {
                Url = url,
